from oneos.utils import parse_global_args
...
def handle_env_command(args):
    env_file = os.path.expanduser("~/.oneos-1/.env")
    ...
    if args.env_command in ["list", "set"]:
        ...
        print("Usage: oneos env {list|set}")
        print("Examples:")
        print("  oneos env list")
        print("  oneos env set OPENAI_API_KEY your_api_key")
