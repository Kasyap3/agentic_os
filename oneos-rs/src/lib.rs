//! oneos-rs: Experimental Rust rewrite scaffold of the oneOS framework.
//!
...
pub const ONEOS_RS_SCAFFOLD_VERSION: &str = "0.0.1-alpha";
...
mod tests {
    ...
    fn version_constant_present() {
        assert_eq!(ONEOS_RS_SCAFFOLD_VERSION, "0.0.1-alpha");
    }
}
